...
public class Ejercicio9 {
	public static void main(String[] args) {
		...
		/*Creamos una alerta para avisar al usuario en caso de que el numero que introduce no sea entero*/
		try {
		...
		/*Creamos un bucle while para dividir el numero entre 10 mientras que sea mayor de nueve es decir que el numero introducido tenga dos cifras*/
		while(numero > 9) {
			numero = numero / 10;
			contador++;
		}
