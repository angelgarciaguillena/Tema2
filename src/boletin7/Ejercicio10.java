...
public class Ejercicio10 {
	public static void main(String[] args) {
		...
		/*Creamos una alerta para el usuario para notificarle en caso de que el numero introducido no sea un entero*/
		try {
		...
		/*Creamos un bucle while para invertir el numero mientras que el numero cambiado sea mayor a 0 */
		while(cambiado > 0) {
		...
		/*Mostramos el resultado al usuario, si el numero es igual al numero invertido el numero sera capicua sino no sera capicua*/
