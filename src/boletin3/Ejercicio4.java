...
public class Ejercicio4 {
	public static void main(String[] args) {
		...
		/*Creamos un switch para transformar el numero en palabras y un default para notificar al usuario por si introduce un numero que no esta dentro del rango*/
		switch(numero) {
		case 1 ->
